            ...
            <div class="span4">
                <div class="user-address-menu">
                    ...
                    <div class="menu-box">
                        ...
                        <ul class="list">
                            <li> <a href="javascript:void(0);">我的个人中心</a> </li>
                            <li> <a href="javascript:void(0);">消息通知</a> </li>
                            <li> <a href="javascript:void(0);">购买资格</a> </li>
                            <li> <a href="javascript:void(0);">现金账户</a> </li>
                            <li> <a href="javascript:void(0);">仲恺礼品卡</a> </li>
                            <li> <a href="javascript:void(0);">现金券</a> </li>
                            <li class="active"> <a href="javascript:void(0);">喜欢的商品</a> </li>
                    ...
                    <div class="menu-box">
                        ...
                        <ul class="list">
                            ...
                            <li> <a href="javascript:void(0);">领取快递报销</a> </li>
                        </ul>
                    </div>
                    <!-- 账户管理 -->
                    <div class="menu-box">
                                        ...
                                        <script type="type/html" id='tpl'>
                                            ...
                                            <li class="xm-goods-list" >
                                                <figure>
                                                    ...
                                                    <figcaption>
                                                        <h3 id="aa">
                                                            <a href="">{{item.pName}} {{item.color}}</a>
                                                        </h3>
                                                        <p class="price">
                                                            <span>
                                                                {{item.pPrice}}元
    ...
    <div class="f-service w">
        ...
        <div class="f-info clearfix">
            ...
            <div class="f-sites fl fs12">
                <p class="sites">
                    <a href="javascripts:;">仲恺商城</a>
                    <sapn>|</sapn>
                    <a href="javascripts:;">MIUI</a>
                    <sapn>|</sapn>
                    <a href="javascripts:;">仲恺</a>
                    <sapn>|</sapn>
                    <a href="javascripts:;">仲聊</a>
                    <sapn>|</sapn>
                    ...
                    <sapn>|</sapn>
                    <a href="javascripts:;">仲恺天猫店</a>
                    <sapn>|</sapn>
                    <a href="javascripts:;">仲恺集团隐私政策</a>
                    <sapn>|</sapn>
                    <a href="javascripts:;">仲恺公司儿童信息保护规则</a>
                    <sapn>|</sapn>
                    <a href="javascripts:;">仲恺商城隐私政策</a>
                    <sapn>|</sapn>
                    <a href="javascripts:;">仲恺商城用户协议</a>
                    <sapn>|</sapn>
                ...
                <div class="sites-pic">
                    <a href="javascripts:;"><img src="./img/copy1.png" alt=""></a>
                    <a href="javascripts:;"><img src="./img/copy2.png" alt=""></a>
                    <a href="javascripts:;"><img src="./img/copy3.png" alt=""></a>
                    <a href="javascripts:;"><img src="./img/copy4.png" alt=""></a>
                    <a href="javascripts:;"><img src="./img/copy5.png" alt=""></a>
                </div>
