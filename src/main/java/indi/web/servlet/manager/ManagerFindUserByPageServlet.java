...
@WebServlet(name = "ManagerFindUserByPageServlet", value = "/ManagerFindUserByPageServlet")
public class ManagerFindUserByPageServlet extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/managerUsersList.jsp").forward(request, response);
    }
}
