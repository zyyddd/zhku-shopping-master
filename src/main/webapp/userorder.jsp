...
<head>
    ...
    <script type="text/javascript">
        ...
        function updateorderStatus(id){
            if(confirm("确认收货吗")){
                location.href = "${pageContext.request.contextPath}/ConfirmGetGoodsServlet?id="+id
            }
        ...
        <table>
            ...
            <c:forEach items="${orders}" var="order" varStatus="s">
                <tr>
                    ...
                    <td><a href="javascript:updateorderStatus(${order._id})"><input type="button" value="确认收货"></a>
                    <a href="${pageContext.request.contextPath}/CommentOrdersServlet?id=${order._id}"><input type="button" value="评价"></a></td>
                </tr>
            </c:forEach>
